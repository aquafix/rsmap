...
public class ConvertXteas {
    public static void main(String[] args) throws Exception {
        var file = new File("F:\\2024dev\\osrs-pathfinder-main\\osrs-pathfinder\\graph-generation\\src\\main\\java\\dev\\dqw4w9wgxcq\\pathfinder\\graphgeneration\\xteasopenrs2.json");
        if (!file.exists()) {
